...
MODEL                := combined_mdl_wpanel
MODULES              := combined_mdl_wpanel_data.c combined_mdl_wpanel_tgtconn.c rt_nonfinite.c
MAKEFILE             := combined_mdl_wpanel.mk
...
TID01EQ              := 1
NCSTATES             := 0
BUILDARGS            :=  REAL_TIME_EXECUTION="kernel" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 OPTS="-DTGTCONN -DEXT_MODE -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=1"
MULTITASKING         := 0
EXT_MODE             := 1
EXTMODE_TRANSPORT    := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := combined_mdl_wpanel_ref.rsp
...
# additional includes
REQ_INCLUDES += ;$(WQ)C:/Users/apm3/ONEDRI~1/_TEACH~1/2025/ENG331/COUPLE~1/MATLAB$(WQ);$(WQ)C:/Users/apm3/ONEDRI~1/_TEACH~1/2025/ENG331/COUPLE~1/MATLAB/combined_mdl_wpanel_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
